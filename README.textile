...
To install you'll need a couple of other emacs packages installed. See "the installation instrictions":http://wiki.github.com/rocky/emacs-dbgr/how-to-install for details.
