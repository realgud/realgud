...
(load-file "../realgud/debugger/undodb-gdb/init.el")
...
(eval-when-compile
  ...
  (defvar realgud:undodb-gdb-pat-hash)
  )

; Some setup usually done in setting up the buffer.
; We customize this for this debugger.
; FIXME: encapsulate this.
(setq dbg-name "undodb-gdb")
...
(set (make-local-variable 'prompt-pat)
     (gethash "prompt" realgud:undodb-gdb-pat-hash))
(prompt-match "(undodb-gdb) ")
