(require 'test-unit)
(load-file "../dbgr/common/init/trepanx.el")

(test-unit-clear-contexts)


(setq bps    (gethash "brkpt-set"     trepanx-pat-hash))
(setq prompt (gethash "prompt"        trepanx-pat-hash))
(setq tb     (gethash "backtrace"     trepanx-pat-hash))
(setq ctrl   (gethash "control-frame" trepanx-pat-hash))
	 ...
	 (lexical-let ((text "	from /usr/local/bin/irb:12:in `<main>'"))
	   ...
	   (specify "control-frame"
	   	    (assert-equal 0 (ctrl-frame-match 
				     "c:0026 p:0181 s:0136 b:0136 l:000135 d:000135 METHOD /trepanx-0.0.1/app/frame.rb:132 "
				     )
				  )
	   	    (assert-equal 0 (ctrl-frame-match 
				     "c:0030 p:0041 s:0144 b:0144 l:00226c d:00226c METHOD /gems/trepanx-0.0.1/processor/eval.rb:15 "
				     )
				  )
	   	    (assert-equal 0 (ctrl-frame-match 
