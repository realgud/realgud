...
into or out of this mode."
  ...
  (if trepan-track-mode
	...
	(local-set-key "\C-c!!"  'trepan-goto-dollarbang-traceback-line)
        (local-set-key "\C-c!c"  'trepan-goto-control-frame-line)
        (local-set-key "\C-c!b"  'trepan-goto-backtrace-line)
	(dbgr-track-mode 't)
