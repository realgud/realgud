...
(require-relative-list '("../../common/track" 
			 ...
			 "../../common/lang")
		       "dbgr-")
(require-relative-list '("init") "dbgr-trepan3k-")


;; FIXME: I think the following could be generalized and moved to 
;; dbgr-... probably via a macro.
(defvar trepan3k-minibuffer-history nil
  "minibuffer history list for the command `trepan3k'.")
...
(defvar trepan3k-command-name) ; # To silence Warning: reference to free variable
(defun trepan3k-suggest-invocation (debugger-name)
  "Suggest a trepan3k command invocation via `dbgr-suggest-invocaton'"
  (dbgr-suggest-invocation trepan3k-command-name trepan3k-minibuffer-history 
			   "python" "\\.py"))
