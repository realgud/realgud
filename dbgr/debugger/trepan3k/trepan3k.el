...
(require-relative-list '("../../common/helper"
			 "../../common/track") "dbgr-")
(require-relative-list '("core" "track-mode") "dbgr-trepan3k-")
...
;;;###autoload
(defun dbgr-trepan3k (&optional opt-command-line no-reset)
...
marginal icons is reset."
  ...
  (let* (
	 ...
	 (cmd-buf))
    (dbgr-run-process "trepan3k" script-name cmd-args 
		      'trepan3k-track-mode no-reset)
    )
  )


(defalias 'trepan3k 'dbgr-trepan3k)
