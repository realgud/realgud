...
(require-relative-list '("../../common/helper"
			 "../../common/track") "dbgr-")
(require-relative-list '("core" "track-mode") "dbgr-pydb-")
...
;;;###autoload
(defun dbgr-pydb (&optional opt-command-line no-reset)
...
marginal icons is reset."
  ...
  (let* (
	 ...
	 (cmd-buf))
    (dbgr-run-process "pydb" script-name cmd-args 
		      'pydb-track-mode no-reset)
    )
  )


(defalias 'pydb 'dbgr-pydb)
