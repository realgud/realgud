...
(require-relative-list '("core" "track-mode") "dbgr-trepan8-")
...
;;;###autoload
(defun dbgr-trepan8 (&optional opt-command-line no-reset)
...
marginal icons is reset."
  ...
  (let* (
	 ...
	 (cmd-buf))
    (dbgr-run-process "trepan8" script-name cmd-args 
		      'trepan8-track-mode no-reset)
    )
  )

(defalias 'trepan8 'dbgr-trepan8)
