...
(require-relative-list '("../../common/track" 
			 ...
			 "../../common/lang")
		       "dbgr-")
(require-relative-list '("init") "dbgr-trepan8-")
...
(defun trepan8-suggest-invocation (debugger-name)
  "Suggest a trepan8 command invocation via `dbgr-suggest-invocaton'"
  (dbgr-suggest-invocation trepan8-command-name trepan8-minibuffer-history 
			   "ruby" "\\.rb$"))
